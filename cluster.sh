...
$MAHOUT kmeans -i topics-vectors-bigram/tfidf-vectors -c topics-kmeans-clusters -o topics-kmeans -dm org.apache.mahout.common.distance.SquaredEuclideanDistanceMeasure -cd 1.0 -k 20 -x 10 -ow --clustering
$MAHOUT clusterdump -i topics-kmeans/clusters-1-final -o $PROJECT_HOME/result/topics_clusters_dump -d topics-vectors-bigram/dictionary.file-0 -dt sequencefile -b 100 -n 10 --evaluate -dm org.apache.mahout.common.distance.SquaredEuclideanDistanceMeasure -sp 0 --pointsDir topics-kmeans/clusteredPoints
